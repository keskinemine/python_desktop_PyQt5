...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(562, 464)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableProducts = QtWidgets.QTableWidget(self.centralwidget)
        self.tableProducts.setGeometry(QtCore.QRect(10, 10, 321, 271))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(350, 50, 201, 161))
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.btnSave)
