...
class Window(QtWidgets.QMainWindow):
    ...
    def showDialog(self):
        ...
        result = QMessageBox.question(self, 'Close Apllication', 'Are you sure ?', QMessageBox.Ok | QMessageBox.Cancel | QMessageBox.Ignore, QMessageBox.Cancel)
...
# pyuic5 msgbox.ui -o msgboxForm.py
# python3 msgbox.py